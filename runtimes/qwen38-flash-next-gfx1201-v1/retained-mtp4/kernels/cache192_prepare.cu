...
// Extracted unchanged planner/copy/publication from R9V cacheparallel, capacity192.
#include <ATen/cuda/CUDAContext.h>
#include <c10/cuda/CUDAGuard.h>
#include <torch/extension.h>
#include <hip/hip_runtime.h>
namespace {
constexpr int kMaxLogicalCacheSlots=192;
...
void tiered_iq_moe_cache_lru_prepare(
  ...
  TORCH_CHECK(cache_w13.size(0) > 0 &&
              ...
              "synchronous LRU cache supports one through192slots");
