...
class Qwen4ExpMTP(
    ...
    def compute_logits(
        ...
        from r9v_draft_w2_rank import draft_head

        return self.logits_processor(draft_head(self), hidden_states)

    def get_top_tokens(self, hidden_states: torch.Tensor) -> torch.Tensor:
        """Return greedy draft tokens without gathering full-vocabulary logits."""
        from r9v_draft_w2_rank import draft_head

        return self.logits_processor.get_top_tokens(draft_head(self), hidden_states)
